...
public class Element : INode
{
	private static void AddStockAttrsToHyperlink(HtmlWriter w, string targetURI)
	{
		...
		{
			w.Attribute("rel", "noopener external ugc"); // for browsers which pre-date `Cross-Origin-Opener-Policy` response header; see https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#security_and_privacy
		}
	}
