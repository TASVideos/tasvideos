...
public class PublicationTests
{
	...
	public void GenerateTitle_NullSystem_ThrowsInvalidOperationException()
	{
		...
		Assert.ThrowsExactly<InvalidOperationException>(() => publication.GenerateTitle(false));
	}
	...
	public void GenerateTitle_NullGameGoal_ThrowsNullReferenceException()
	{
		...
		Assert.ThrowsExactly<NullReferenceException>(() => publication.GenerateTitle(false));
	}
