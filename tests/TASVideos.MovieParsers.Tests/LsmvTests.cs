...
public class LsmvTests : BaseParserTests
{
	...
	[DataRow("gametype-sgb_ntsc.lsmv", SystemCodes.GameBoy, RegionType.Ntsc, FrameRates.Snes)]
	[DataRow("gametype-sgb_pal.lsmv", SystemCodes.GameBoy, RegionType.Pal, FrameRates.SnesPAL)]
