...
public class JrsrTests : BaseParserTests
{
	...
	protected override string ResourcesPath => "TASVideos.MovieParsers.Tests.JrsrSampleFiles.";
	...
	[DataRow(
		...
		""", "foo", null, "bar", null, "foo", null, null)]
...
"!END\n" +
"", "foo", "\x20\x20hello\x20world\x20\x20", null, null)]
