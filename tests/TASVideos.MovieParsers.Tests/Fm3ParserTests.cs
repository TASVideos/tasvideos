...
public class Fm3ParserTests : BaseParserTests
{
	...
	{
		var result = await _fm3Parser.Parse(Embedded("ntsc.fm3"), EmbeddedLength("ntsc.fm3"));
	...
	{
		var result = await _fm3Parser.Parse(Embedded("pal.fm3"), EmbeddedLength("pal.fm3"));
		Assert.IsTrue(result.Success, "Result is successful");
		Assert.AreEqual(2, result.Frames, "Frame count should be 2");
	...
	{
		var result = await _fm3Parser.Parse(Embedded("fds.fm3"), EmbeddedLength("fds.fm3"));
		Assert.IsTrue(result.Success, "Result is successful");
		Assert.AreEqual(2, result.Frames, "Frame count should be 2");
		Assert.AreEqual(RegionType.Ntsc, result.Region);
		Assert.AreEqual(21, result.RerecordCount);
	...
	{
		var result = await _fm3Parser.Parse(Embedded("savestate.fm3"), EmbeddedLength("savestate.fm3"));
		Assert.IsTrue(result.Success, "Result is successful");
		Assert.AreEqual(2, result.Frames, "Frame count should be 2");
		Assert.AreEqual(RegionType.Ntsc, result.Region);
		Assert.AreEqual(21, result.RerecordCount);
	...
	{
		var result = await _fm3Parser.Parse(Embedded("norerecords.fm3"), EmbeddedLength("norerecords.fm3"));
	...
	{
		var result = await _fm3Parser.Parse(Embedded("binary.fm3"), EmbeddedLength("binary.fm3"));
		Assert.IsTrue(result.Success, "Result is successful");
		Assert.AreEqual(2, result.Frames, "Frame count should be 2");
		AssertNoWarningsOrErrors(result);
	}
	...
	{
		var result = await _fm3Parser.Parse(Embedded("invalidversion.fm3"), EmbeddedLength("invalidversion.fm3"));
	...
	{
		var result = await _fm3Parser.Parse(Embedded("noromfilename.fm3"), EmbeddedLength("noromfilename.fm3"));
		Assert.IsFalse(result.Success);
		AssertNoWarnings(result);
		Assert.AreEqual(1, result.Errors.Count());
	...
	{
		var result = await _fm3Parser.Parse(Embedded("noromchecksum.fm3"), EmbeddedLength("noromchecksum.fm3"));
		Assert.IsFalse(result.Success);
		AssertNoWarnings(result);
		Assert.AreEqual(1, result.Errors.Count());
	...
	{
		var result = await _fm3Parser.Parse(Embedded("noguid.fm3"), EmbeddedLength("noguid.fm3"));
		Assert.IsFalse(result.Success);
		AssertNoWarnings(result);
		Assert.AreEqual(1, result.Errors.Count());
	...
	{
		var result = await _fm3Parser.Parse(Embedded("hash.fm3"), EmbeddedLength("hash.fm3"));
		Assert.IsTrue(result.Success);
