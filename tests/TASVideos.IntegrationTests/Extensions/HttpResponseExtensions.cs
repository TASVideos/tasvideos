...
public static class HttpResponseExtensions
{
	extension(HttpResponseMessage response)
	{
		...
		/// </summary>
		public void EnsureSuccessStatusCode(string? context = null)
		{
		...
		/// </summary>
		public async Task<IEnumerable<IElement>> QuerySelectorAllAsync(string selector)
		{
			var document = await response.GetHtmlDocumentAsync();
		...
		/// </summary>
		public async Task<IElement?> QuerySelectorAsync(string selector)
		{
			var document = await response.GetHtmlDocumentAsync();
			return document.QuerySelector(selector);
		}

		private async Task<IHtmlDocument> GetHtmlDocumentAsync()
		{
			var content = await response.Content.ReadAsStringAsync();
