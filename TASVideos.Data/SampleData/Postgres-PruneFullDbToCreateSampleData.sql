...
UPDATE public.users 
	SET signature = NULL,
		...
		email = 'tasvideos' || public.users.id || '@example.com', --We don't want these public, but a valid email address is necessary for many user operations
		normalized_email = 'TASVIDEOS' || public.users.id || '@example.com', -- We don't want to make these public either
