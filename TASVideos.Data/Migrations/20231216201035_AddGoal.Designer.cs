...
namespace TASVideos.Data.Migrations
{
    ...
    [Migration("20231216201035_AddGoal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Game.GameGoal", b =>
                {
                    ...
                    b.HasIndex("GoalId")
                        .HasDatabaseName("ix_game_goals_goal_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Game.Goal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("DisplayName")
                        .IsUnique()
                        .HasDatabaseName("ix_goals_display_name");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Game.GameGoal", b =>
                {
                    ...
                    b.HasOne("TASVideos.Data.Entity.Game.Goal", "Goal")
                        .WithMany("GameGoals")
                        .HasForeignKey("GoalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_game_goals_goals_goal_id");
