...
namespace TASVideos.Data.Migrations
{
    ...
    [Migration("20210312232856_InitialCreate")]
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Forum.ForumTopic", b =>
                {
                    ...
                    b.HasIndex("PageName")
                        .IsUnique()
                        .HasDatabaseName("ix_forum_topics_page_name");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Publication", b =>
                {
                    ...
                    b.HasIndex("TierId")
                        .HasDatabaseName("ix_publications_tier_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Submission", b =>
                {
                    ...
                    b.Property<int?>("IntendedTierId")
                        .HasColumnType("integer")
                        .HasColumnName("intended_tier_id");
                    ...
                    b.HasIndex("IntendedTierId")
                        .HasDatabaseName("ix_submissions_intended_tier_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Publication", b =>
                {
                    ...
                    b.HasOne("TASVideos.Data.Entity.Tier", "Tier")
                        ...
                        .HasConstraintName("fk_publications_tiers_tier_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Submission", b =>
                {
                    ...
                    b.HasOne("TASVideos.Data.Entity.Tier", "IntendedTier")
                        ...
                        .HasConstraintName("fk_submissions_tiers_intended_tier_id");
