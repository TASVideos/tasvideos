		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					icon_path = table.Column<string>(type: "citext", maxLength: 100, nullable: false),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					page_name = table.Column<string>(type: "citext", maxLength: 200, nullable: true),
					create_timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
					create_user_name = table.Column<string>(type: "citext", nullable: true),
					last_update_timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
					last_update_user_name = table.Column<string>(type: "citext", nullable: true)
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					enable_html = table.Column<bool>(type: "boolean", nullable: false),
					enable_bb_code = table.Column<bool>(type: "boolean", nullable: false),
					poster_mood = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
					create_timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
					create_user_name = table.Column<string>(type: "citext", nullable: true),
					last_update_timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
					last_update_user_name = table.Column<string>(type: "citext", nullable: true)
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					intended_tier_id = table.Column<int>(type: "integer", nullable: true),
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						...
						onDelete: ReferentialAction.Restrict);
					table.ForeignKey(
						name: "fk_submissions_tiers_intended_tier_id",
						column: x => x.intended_tier_id,
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						...
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "fk_publications_tiers_tier_id",
						column: x => x.tier_id,
						principalTable: "tiers",
						principalColumn: "id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateIndex(
				name: "ix_forum_topics_page_name",
				table: "forum_topics",
				column: "page_name",
				unique: true);
			...
			migrationBuilder.CreateIndex(
				name: "ix_submissions_intended_tier_id",
				table: "submissions",
				column: "intended_tier_id");
