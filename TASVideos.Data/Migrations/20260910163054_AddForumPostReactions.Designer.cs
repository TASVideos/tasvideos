...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Forum.ForumPostReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forum_post_reactions");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_forum_post_reactions_user_id");

                    b.HasIndex("PostId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_forum_post_reactions_post_id_user_id");

                    b.ToTable("forum_post_reactions", (string)null);
                });
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Forum.ForumPostReaction", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Forum.ForumPost", "Post")
                        .WithMany("Reactions")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forum_post_reactions_forum_posts_post_id");
                    ...
                    b.HasOne("TASVideos.Data.Entity.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forum_post_reactions_users_user_id");
