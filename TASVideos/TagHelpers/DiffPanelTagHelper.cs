...
public class DiffPanelTagHelper : TagHelper
{
	...
	public override void Process(TagHelperContext context, TagHelperOutput output)
	{
		...
		output.Content.AppendHtml(
			"""
			<div class="card-header collapsed" data-bs-toggle="collapse" data-bs-target="#diff-container">
				<a class="text-body" role="button"><i class="fa fa-chevron-circle-down"></i> Diff</a>
			</div>
