...
In accordance with the [tasvideos AI policy](https://tasvideos.org/AIPolicy), we do not accept contributions that utilize GenAI tools such as Claude Code, Chat GPT, etc.  This includes issues as well as Pull-requests and other contributions.
