...
public static class ServiceCollectionExtensions
{
	...
	{
		public IServiceCollection AddTasvideosCore<T1, T2>(bool isDevelopment, AppSettings settings)
		...
		private IServiceCollection AddServices(AppSettings settings)
		{
			...
			services.AddScoped<IWikiRedirectService, WikiRedirectService>();
		...
		private IServiceCollection AddCacheService(AppSettings.CacheSetting cacheSettings)
		{
		...
		private IServiceCollection AddExternalMediaPublishing(AppSettings settings, bool isDevelopment)
		{
			if (isDevelopment)
			{
